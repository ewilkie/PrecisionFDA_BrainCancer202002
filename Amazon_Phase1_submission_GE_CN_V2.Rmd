...
Phase1_CN_GE_out <- read.table("sc3_Phase1_CN_GE_FeatureMatrix.txt", sep="\t", header=T, row.names=1)
dim(Phase1_CN_GE_out)

y <- read.table("sc3_Phase1_CN_GE_Outcome.txt", sep="\t", header=T, row.names=1)
...
hu <- read.table("Sc1_GE_names.csv", sep=",")
...
write.table(imp, "Sc3_GE_CN_important_features.csv",  sep=",")
